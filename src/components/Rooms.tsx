...
const rooms = [
  {
    ...
    price: '799',
    capacity: '2 Persons',
    features: ['Attached Washroom', 'Free Wi-Fi', 'Daily Housekeeping', '24/7 Hot Water'],
    highlight: false,
  ...
  },
  {
    ...
    price: '999',
    capacity: '2 Persons',
    features: ['Air Conditioned', 'Attached Washroom', 'Free Wi-Fi', 'Premium Bedding'],
    highlight: true,
  ...
  },
  {
    ...
    price: '999',
    capacity: '3 Persons',
    features: ['Extra Space', 'Attached Washroom', 'Free Wi-Fi', 'Daily Housekeeping'],
    highlight: false,
  ...
  },
  {
    ...
    price: '1199',
    capacity: '3 Persons',
    features: ['Air Conditioned', 'Extra Bed', 'Premium Amenities', 'Free Wi-Fi'],
    highlight: false,
    ...
    <section id="rooms" className="py-24 bg-ivory-100">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-16 animate-on-scroll animate-fade-in">
          ...
          <h2 className="text-4xl font-serif text-maroon-800">Rooms & Pricing</h2>
            ...
            >
              <div className="flex-grow">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className={`${room.highlight ? 'text-gold-500' : 'text-maroon-800'} font-semibold text-sm font-serif`}>₹{room.price}</span>
                </div>
