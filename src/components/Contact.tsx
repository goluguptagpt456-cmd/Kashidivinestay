        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-5/12 animate-on-scroll animate-fade-in">
            ...
            <div className="space-y-4">
              <a href="tel:+919250474216" className="flex items-center gap-4 bg-charcoal-900/40 p-4 border border-gold-500/20 hover:border-gold-500/50 transition-colors group">
                ...
                <div>
                  ...
                  <span className="text-xl font-serif tracking-wide text-white group-hover:text-gold-500 transition-colors">+91 92504 74216</span>
                </div>
              </a>

              <a href="https://wa.me/917052519843" target="_blank" rel="noreferrer" className="flex items-center gap-4 bg-charcoal-900/40 p-4 border border-gold-500/20 hover:border-gold-500/50 transition-colors group">
                ...
                <div>
                  ...
                  <span className="text-xl font-serif tracking-wide text-white group-hover:text-[#25D366] transition-colors">+91 70525 19843</span>
                </div>
              </a>

              <a href="mailto:info@kashidivinestay.com" className="flex items-center gap-4 p-4 border border-transparent hover:border-gold-500/20 transition-colors group">
                ...
                <div>
                  ...
                  <span className="text-sm tracking-wide text-white/90 group-hover:text-white transition-colors">info@kashidivinestay.com</span>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="lg:w-7/12 bg-ivory-100 p-8 md:p-12 lg:p-16 text-charcoal-900 relative shadow-2xl animate-on-scroll animate-fade-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="relative">
                ...
                >
                  <option value="non-ac-2">Standard Non-AC Room (2 Persons) - ₹799</option>
                  <option value="ac-2">Comfort AC Room (2 Persons) - ₹999</option>
                  <option value="non-ac-3">Family Non-AC Room (3 Persons) - ₹999</option>
                  <option value="ac-3">Premium Family AC Room (3 Persons) - ₹1199</option>
                </select>
              </div>
