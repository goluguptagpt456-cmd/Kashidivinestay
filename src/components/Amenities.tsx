import { BedDouble, Wind, Sparkles, Clock, Key, Smartphone } from 'lucide-react';

export default function Amenities() {
  const amenitiesList = [
    { icon: <BedDouble size={28} strokeWidth={1.5} />, title: "Family Rooms", desc: "Spacious accommodation for the whole family.", delayClass: "delay-100" },
    { icon: <Wind size={28} strokeWidth={1.5} />, title: "AC Rooms", desc: "Cool and comfortable rooms available.", delayClass: "delay-200" },
    { icon: <Sparkles size={28} strokeWidth={1.5} />, title: "Clean & Peaceful", desc: "Maintained to the highest hygiene standards.", delayClass: "delay-300" },
    { icon: <Clock size={28} strokeWidth={1.5} />, title: "24×7 Support", desc: "Round-the-clock assistance for our guests.", delayClass: "delay-400" },
    { icon: <Key size={28} strokeWidth={1.5} />, title: "Easy Check-in", desc: "Hassle-free arrival and departure process.", delayClass: "delay-500" },
    { icon: <Smartphone size={28} strokeWidth={1.5} />, title: "Online Booking", desc: "Secure and quick online reservations.", delayClass: "delay-600" },
  ];
